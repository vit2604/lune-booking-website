...
import { bookingRateLimit, publicReadRateLimit } from '../../middlewares/rateLimitMiddleware.js';
...
publicBookingRouter.get('/:bookingCode', publicReadRateLimit, validate(bookingCodeSchema), publicBooking);
